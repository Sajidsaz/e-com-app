...
const NewsletterBox = () => {
  ...
  return (
    <div className='text-center'>
        <p className='text-2xl font-medium text-gray-800' >Stay Ahead of Fashion Trends</p>
        <p className='text-gray-400 mt-3'>
            Subscribe to our newsletter and be the first to discover new arrivals, exclusive offers, style inspiration, and member-only promotions.
        </p>
